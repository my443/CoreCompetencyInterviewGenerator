 ...
 INSERT INTO 'Interviews' ('Id', 'InterviewName', 'DateCreated', 'IsActive') VALUES (1, 'DSP Interview for Group Living', '2025-11-02 00:00:00', 1);
 INSERT INTO 'Interviews' ('Id', 'InterviewName', 'DateCreated', 'IsActive') VALUES (2, 'Night Sleep DSP Interview', '2025-11-02 00:00:00', 1);

 DELETE FROM InterviewQuestion;
            INSERT INTO 'InterviewQuestion' ('InterviewsId', 'QuestionsId') VALUES (1, 1);
            INSERT INTO 'InterviewQuestion' ('InterviewsId', 'QuestionsId') VALUES (1, 10);
            INSERT INTO 'InterviewQuestion' ('InterviewsId', 'QuestionsId') VALUES (1, 68);
            INSERT INTO 'InterviewQuestion' ('InterviewsId', 'QuestionsId') VALUES (1, 117);
            INSERT INTO 'InterviewQuestion' ('InterviewsId', 'QuestionsId') VALUES (2, 1);
            INSERT INTO 'InterviewQuestion' ('InterviewsId', 'QuestionsId') VALUES (2, 105);
            INSERT INTO 'InterviewQuestion' ('InterviewsId', 'QuestionsId') VALUES (2, 100);
            INSERT INTO 'InterviewQuestion' ('InterviewsId', 'QuestionsId') VALUES (2, 10);
            INSERT INTO 'InterviewQuestion' ('InterviewsId', 'QuestionsId') VALUES (2, 67); 